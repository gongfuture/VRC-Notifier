...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      'settings.accessKey.regenerate': '保存密钥',
      'settings.accessKey.warning': '提示：修改密钥后，之前保存的密钥将失效，需要使用新密钥重新输入！',
      'settings.accessKey.empty': '访问密钥不能为空',
      'settings.accessKey.reverify': '访问密钥已更新，请重新验证访问密钥。',
      ...
      'general.accessKey.regenerate': '保存密钥',
      'general.accessKey.warning': '提示：修改密钥后，之前保存的密钥将失效，需要使用新密钥重新输入！',
    ...
    en: {
      ...
      'settings.accessKey.regenerate': 'Save Key',
      'settings.accessKey.warning': 'Notice: After changing the key, the previous key will become invalid and you will need to enter the new key again!',
      'settings.accessKey.empty': 'Access key cannot be empty',
      'settings.accessKey.reverify': 'Access key updated. Please verify the access key again.',
      ...
      'general.accessKey.regenerate': 'Save Key',
      'general.accessKey.warning': 'Notice: After changing the key, the previously saved key will become invalid and you will need to enter the new key again!',
